...
version_substitions = {
    "@PROJECT_VERSION_MAJOR@": str(ROCSHMEM_MAJOR),
...
cc_library(
    ...
    include_prefix = "third_party/rocshmem",
...
write_file(
    name = "rocshmem_config_header",
    out = "rocshmem_config.h",
    content = [
        "constexpr static char XLA_ROCSHMEM_VERSION[] = \"{}\";".format(ROCSHMEM_MAJOR),
    ],
)
