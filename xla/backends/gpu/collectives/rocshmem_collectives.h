...
#ifndef XLA_BACKENDS_GPU_COLLECTIVES_ROCSHMEM_COLLECTIVES_H_
#define XLA_BACKENDS_GPU_COLLECTIVES_ROCSHMEM_COLLECTIVES_H_
...
// AMD ROCSHMEM library
class RocshmemCollectives : public GpuCollectives {
 public:
  ~RocshmemCollectives() override;

  static RocshmemCollectives* Default();
 ...
 private:
  ...
  static constexpr char kKvStoreKey[] = "rocshmem_global_init";
};

}  // namespace xla::gpu

#endif  // XLA_BACKENDS_GPU_COLLECTIVES_ROCSHMEM_COLLECTIVES_H_
